...
extension ImageResource {
    ...
    static let bgPiscum = ImageResource(name: "bg_piscum", bundle: resourceBundle)
    ...
    static let indicator = ImageResource(name: "indicator", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "bg_piscum" asset catalog image.
    static var bgPiscum: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .bgPiscum)
#else
        .init()
#endif
    }

    /// The "error" asset catalog image.
    static var error: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .error)
#else
        .init()
    ...
    /// The "indicator" asset catalog image.
    static var indicator: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .indicator)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "bg_piscum" asset catalog image.
    static var bgPiscum: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .bgPiscum)
#else
        .init()
    ...
    /// The "error" asset catalog image.
    static var error: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .error)
#else
        .init()
    ...
    /// The "indicator" asset catalog image.
    static var indicator: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .indicator)
#else
        .init()
